...
@Component({
  selector: 'app-set3game3',
  templateUrl: './set3game3.component.html',
  styleUrls: ['./set3game3.component.scss']
})
export class Set3game3Component implements OnInit {
  circles:Circle[];
  ok:number=0
  rects:Rect[];
exercises:Exercise
   ...
   this.ok+=1;
    ...
    { 
      ...
      setTimeout(()=>{
        ...
        this.router.navigate(['/main/homeAutism/sets/set3game4']);
