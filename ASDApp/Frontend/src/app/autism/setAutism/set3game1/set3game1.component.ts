...
@Component({
  selector: 'app-set3game1',
  templateUrl: './set3game1.component.html',
  styleUrls: ['./set3game1.component.scss']
})
export class Set3game1Component implements OnInit {
  circles:Circle[];
  ok:number=0;
  rects:Rect[];
exercises:Exercise
   ...
   this.ok+=1;
    ...
    { 
      ...
      setTimeout(()=>{
        ...
        this.router.navigate(['/main/homeAutism/sets/set3game2']);
