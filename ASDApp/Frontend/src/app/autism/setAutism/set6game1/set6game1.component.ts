...
@Component({
  selector: 'app-set6game1',
  templateUrl: './set6game1.component.html',
  styleUrls: ['./set6game1.component.scss']
})
export class Set6game1Component implements OnInit {
  animals:Entity[]
  numbers:Entity[]
  exercises:Exercise
  ok:number=0
  ...
  CheckWin()
  {
   this.ok+=1;
    ...
    { 
      ...
      this.okA=1;
      setTimeout(()=>{
        this.router.navigate(['/main/homeAutism/sets/set6game2']);},3000);
