...
@Component({
  selector: 'app-set4game3',
  templateUrl: './set4game3.component.html',
  styleUrls: ['./set4game3.component.scss']
})
export class Set4game3Component implements OnInit {
   ...
   this.ok+=1;
    ...
    { 
      ...
      setTimeout(()=>{
        ...
        this.router.navigate(['/main/homeAutism/sets/set4game4']);
