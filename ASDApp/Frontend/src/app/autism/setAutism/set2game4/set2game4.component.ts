...
@Component({
  selector: 'app-set2game4',
  templateUrl: './set2game4.component.html',
  styleUrls: ['./set2game4.component.scss']
})
export class Set2game4Component implements OnInit {
   ...
   this.ok+=1;
    ...
    { 
      ...
      setTimeout(()=>{
        ...
        this.router.navigate(['/main/homeAutism/sets/set2game5']);
