...
@Component({
  selector: 'app-set5game1',
  templateUrl: './set5game1.component.html',
  styleUrls: ['./set5game1.component.scss']
})
export class Set5game1Component implements OnInit {
   ...
   this.ok+=1;
    ...
    { 
      ...
      setTimeout(()=>{
        ...
        this.router.navigate(['/main/homeAutism/sets/set5game2']);
