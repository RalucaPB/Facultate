...
@Component({
  selector: 'app-set5game3',
  templateUrl: './set5game3.component.html',
  styleUrls: ['./set5game3.component.scss']
})
export class Set5game3Component implements OnInit {
  exercises:Exercise
  circles:Circle[];
  ok:number=0
  polygons:Polygon[];
   ...
   this.ok+=1;
    ...
    { 
      ...
      setTimeout(()=>{
        ...
        this.router.navigate(['/main/homeAutism/sets/set5game4']);
