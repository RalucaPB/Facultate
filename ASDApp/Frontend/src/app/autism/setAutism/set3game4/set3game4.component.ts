...
@Component({
  selector: 'app-set3game4',
  templateUrl: './set3game4.component.html',
  styleUrls: ['./set3game4.component.scss']
})
export class Set3game4Component implements OnInit {
  circles:Circle[];
  ok:number=0;
  rects:Rect[];
exercises:Exercise
   ...
   this.ok+=1;
    ...
    { 
      ...
      setTimeout(()=>{
        ...
        this.router.navigate(['/main/homeAutism/sets/set3game5']);
