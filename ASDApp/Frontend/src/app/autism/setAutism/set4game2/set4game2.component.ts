...
@Component({
  selector: 'app-set4game2',
  templateUrl: './set4game2.component.html',
  styleUrls: ['./set4game2.component.scss']
})
export class Set4game2Component implements OnInit {
   ...
   this.ok+=1;
    ...
    { 
      ...
      setTimeout(()=>{
        ...
        this.router.navigate(['/main/homeAutism/sets/set4game3']);
