...
@Component({
  selector: 'app-set4game1',
  templateUrl: './set4game1.component.html',
  styleUrls: ['./set4game1.component.scss']
})
export class Set4game1Component implements OnInit {
   ...
   this.ok+=1;
    ...
    { 
      ...
      setTimeout(()=>{
        ...
        this.router.navigate(['/main/homeAutism/sets/set4game2']);
