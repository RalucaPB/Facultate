...
@Component({
  selector: 'app-set-sd8game1',
  templateUrl: './set-sd8game1.component.html',
  styleUrls: ['./set-sd8game1.component.scss']
})
export class SetSd8game1Component implements OnInit {
    ...
    { 
     ...
     this.okA=1;
      ...
      setTimeout(()=>{
        ...
        this.router.navigate(['/main/homeSindromDown/sets/set8game2']);
