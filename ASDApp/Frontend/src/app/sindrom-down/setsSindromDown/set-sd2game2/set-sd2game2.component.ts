...
@Component({
  selector: 'app-set-sd2game2',
  templateUrl: './set-sd2game2.component.html',
  styleUrls: ['./set-sd2game2.component.scss']
})
export class SetSd2game2Component implements OnInit {
