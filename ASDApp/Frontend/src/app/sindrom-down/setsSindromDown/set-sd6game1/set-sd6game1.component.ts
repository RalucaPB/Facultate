...
@Component({
  selector: 'app-set-sd6game1',
  templateUrl: './set-sd6game1.component.html',
  styleUrls: ['./set-sd6game1.component.scss']
})
export class SetSd6game1Component implements OnInit {
  ...
  onSelect(a: Entity): void {
    ...
    if(a.idEntity=="gresit2")
    setTimeout(()=>{
      this.router.navigate(['/main/homeSindromDown/sets/set6game2']);},3000);
