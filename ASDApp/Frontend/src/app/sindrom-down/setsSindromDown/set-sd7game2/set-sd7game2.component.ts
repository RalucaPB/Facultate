...
@Component({
  selector: 'app-set-sd7game2',
  templateUrl: './set-sd7game2.component.html',
  styleUrls: ['./set-sd7game2.component.scss']
})
export class SetSd7game2Component implements OnInit {
