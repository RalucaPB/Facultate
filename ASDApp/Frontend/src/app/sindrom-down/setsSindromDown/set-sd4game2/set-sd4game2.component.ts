...
@Component({
  selector: 'app-set-sd4game2',
  templateUrl: './set-sd4game2.component.html',
  styleUrls: ['./set-sd4game2.component.scss']
})
export class SetSd4game2Component implements OnInit {
