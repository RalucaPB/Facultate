...
@Component({
  selector: 'app-set-sd1game2',
  templateUrl: './set-sd1game2.component.html',
  styleUrls: ['./set-sd1game2.component.scss']
})
export class SetSd1game2Component implements OnInit {
