...
@Component({
  selector: 'app-set-sd5game2',
  templateUrl: './set-sd5game2.component.html',
  styleUrls: ['./set-sd5game2.component.scss']
})
export class SetSd5game2Component implements OnInit {
  animals:Entity[]
  exercises:Exercise;
  audio:any;
  audioC:any;
