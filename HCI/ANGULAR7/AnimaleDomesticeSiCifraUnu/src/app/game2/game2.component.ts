...
import { PUI1 } from '../model/pui.source';
import { ANIMALS2 } from '../model/game2.source';
  ...
  CheckWin()
  {
   this.ok+=1;
    ...
    { 
      ...
      audio.play();
      this.animal2.forEach(contact => {
        contact.id=contact.id.replace("transparent","");
      });
      this.pui2.forEach(contact => {
        contact.id=contact.id.replace("transparent","");
      });
      setTimeout(()=>{
      ...
      if (this.lastSelected == null){
        ...
        //  let audio = new Audio('../../assets/audios/MaiIncearca.mp3');
         ...
         // audio.play();
          ...
          if ((this.lastSelected.id == "pisica1" && a.id == "pisica2")||(this.lastSelected.id == "pisica2" && a.id == "pisica1")) {
              this.correct(a, this.lastSelected);
              this.lastSelected = null;
              this.porcDone = true;
              let image=new Image();
          ...
          if ((this.lastSelected.id == "caine1" && a.id == "caine2")||(this.lastSelected.id == "caine2" && a.id == "caine1")) {
              this.correct(a, this.lastSelected);
              this.lastSelected = null;
              this.vacaDone = true;
              let image=new Image();
